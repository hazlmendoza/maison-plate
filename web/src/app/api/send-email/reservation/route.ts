...
export async function POST(request: NextRequest) {
  try {
    ...
    const message =
      body.message ||
      `Thank you for choosing Maison Plate. We look forward to welcoming you!`
      ...
      <table role="presentation" width="100%" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:14px;border:1px solid #e0dfd9;overflow:hidden;border-collapse:collapse;">
                  ...
                  <table role="presentation" style="border-collapse:collapse;">
                    <tr>
                      ...
                      <td style="vertical-align:middle;">
                        <p style="margin:0;color:#ffffff;font-size:15px;font-weight:500;line-height:1.2;">Maison Plate</p>
        ...
        <tr>
          <td style="border-top:1px solid #e5e7eb;background:#f9fafb;padding:16px 28px;">
            <table role="presentation" width="100%" style="border-collapse:collapse;">
              <tr>
                <td style="font-size:12px;color:#9ca3af;">This email was sent from Maison Plate</td>
                <td style="text-align:right;font-size:12px;color:#c5c9ce;">© ${new Date().getFullYear()} Maison Plate</td>
              </tr>
            </table>
          </td>
        </tr>
