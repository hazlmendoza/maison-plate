...
export const metadata: Metadata = {
    ...
    title: {
        default: "Maison Plate - Premium Coffee Shop & Cocktail Bar Philippines",
        template: "%s | Maison Plate",
    },

    description:
        "Experience premium artisan coffee by day, craft cocktails by night at Maison Plate. A sophisticated café and bar offering curated coffee, gourmet meals, and signature cocktails in a premium ambiance.",
    ...
    openGraph: {
        ...
        title: "Maison Plate - Premium Coffee Shop & Cocktail Bar Philippines",
        description:
            "Artisan coffee by day, craft cocktails by night. Experience premium café culture with gourmet meals and signature drinks at Maison Plate.",
        images: [
            {
                url: "https://lumebeanandbar.com/og-image.jpg",
                width: 1200,
                height: 630,
                alt: "Maison Plate - Premium Coffee Shop & Cocktail Bar",
                type: "image/jpeg",
            },
            {
            ...
            },
            {
                ...
                width: 1200,
                height: 630,
                alt: "Maison Plate Interior Ambiance",
                type: "image/jpeg",
            },
            {
                ...
                width: 1200,
                height: 630,
                alt: "Premium Coffee and Cocktails at Maison Plate",
                type: "image/jpeg",
            },
        ],
    ...
    twitter: {
        ...
        title: "Maison Plate - Premium Coffee Shop & Cocktail Bar Philippines",
        description:
            "Experience premium artisan coffee by day, craft cocktails by night at Maison Plate. Sophisticated café and bar with gourmet meals and signature drinks.",
    ...
    other: {
        ...
        "apple-mobile-web-app-title": "Maison Plate",
        "application-name": "Maison Plate",
...
export default function RootLayout({
    ...
    const websiteSchema = {
        ...
        "url": "https://lumebeanandbar.com",
        "name": "Maison Plate - Premium Coffee Shop & Cocktail Bar Philippines",
        "description": "Experience premium artisan coffee by day, craft cocktails by night at Maison Plate",
        "publisher": {
            "@id": "https://lumebeanandbar.com/#organization"
        },
        "potentialAction": {
    ...
    const faqSchema = {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "What makes Maison Plate special?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Maison Plate offers a unique experience of premium artisan coffee by day and craft cocktails by night. We feature specialty coffee drinks, gourmet meals, and signature cocktails in a sophisticated ambiance perfect for any occasion."
                }
            },
            {
                "@type": "Question",
                "name": "Does Maison Plate accept reservations?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Do you serve food at Maison Plate?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Is Maison Plate family-friendly?",
                "acceptedAnswer": {
                    "@type": "Answer",
    ...
    return (
        <html lang="en-PH">
            <head>
                ...
                <meta property="og:image:alt" content="Maison Plate - Premium Coffee Shop & Cocktail Bar" />

                {/* Twitter Card Image */}
                <meta name="twitter:image" content="https://lumebeanandbar.com/og-image.jpg" />
                <meta name="twitter:image:alt" content="Maison Plate" />
