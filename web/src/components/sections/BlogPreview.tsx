...
export default function BlogPreview() {
  ...
  return (
    ...
    <section className="dark relative py-24 bg-background border-t border-accent/10 text-foreground overflow-hidden">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          >
            Latest from the <span className="text-accent italic">Journal</span>
          </h2>
        </motion.div>
        ...
        {loading && (
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[...Array(2)].map((_, i) => (
              <div
                key={i}
                className="animate-pulse rounded-sm border border-foreground/10 bg-foreground/5"
              >
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {posts.slice(0, 2).map((post, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="group bg-card rounded-sm border border-foreground/10 overflow-hidden hover:shadow-lg hover:shadow-accent/20 transition"
                >
                  {/* Image */}
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="text-lg font-semibold mt-1 mb-2 text-foreground">
                      {post.title}
                    </h3>
        ...
        {!loading && posts.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-foreground/60 max-w-md">
              ...
              <br />
              Stay tuned for fresh content from our kitchen!
            </p>
