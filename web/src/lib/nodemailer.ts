...
// Maison Plate themed email template
...
export async function sendVerificationEmail(
  ...
  const mailOptions = {
    from: process.env.SMTP_FROM || `"Maison Plate" <${process.env.SMTP_USER}>`,
    to: email,
    subject: 'Verify Your Email - Maison Plate',
    html: `
  <!DOCTYPE html>
  <html>
    <head>
